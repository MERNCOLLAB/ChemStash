...
const faqsContent = (
    ...
    <div className="max-w-2xl">
        ...
        <p className="max-w-[90%]">Users can record and oversee chemicals easily, analyze chemical usage patterns, and be notified for low or expired inventories.</p>
    </div>

    <div className="max-w-2xl">
        <h1 className="text-lg font-semibold mb-1">Can it help with regulatory compliance?</h1>
        <p className="max-w-[95%]">Yes, it can assist with the general regulatory compliance as it allows you to upload a schematic laboratory map, safety data sheet URL links, and provide safety information about the chemicals.</p>
    </div>
    
    <div className="max-w-2xl">
        <h1 className="text-lg font-semibold mb-1">What are the chemical information you need to provide?</h1>
        <p className="max-w-[98%]">Most of the required information for the chemical includes details such as chemical name, CAS registry number, storage location, date received and expiration,
        and some safety information.</p>
    </div>
    
    <div className="max-w-2xl">
        <h1 className="text-lg font-semibold mb-1">What other features does the app offer?</h1>
        <p className="max-w-[95%]">In ChemStack, managers and team leaders have the ability to assign tasks to anyone and get notified. This ensures a smooth and efficient laboratory operation.</p>
    </div>
  </>
)
